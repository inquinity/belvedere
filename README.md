...
- **Edit Mode** — edit Markdown in place with a formatting toolbar for headings, emphasis, lists, quotes, code, and links. Toggle it from the toolbar or with <kbd>⌘E</kbd>, and save with <kbd>⌘S</kbd>, or with a Save button added through *View → Customize Toolbar…*. Leaving edit mode with unsaved changes asks whether to save them, keep them for later, or revert them — or, with the setting turned on, simply keeps them.
