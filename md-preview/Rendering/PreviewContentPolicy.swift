...
///
/// The companion to `QuickLookContentPolicy`. `com.apple.security.network.client`
/// cannot be removed from either target — WKWebView will not complete a load
/// without it, and both surfaces render blank — so the sandbox cannot stop a
/// document from reaching the network. This policy is what does.
///
...
/// whom (by IP) and when. See #339 for the full write-up and a working PoC.
///
